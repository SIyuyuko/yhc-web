...
var ve=Object.getPrototypeOf;var fe=Reflect.get;var lt=(e,t,s)=>fe(ve(e),s,t);import{x as h,y as Nt,z as L,A as k,B as he,C as U,D as Bt,E as A,G as $e,H as Rt,I as x,J as Ft,K as be,L as mt,M as E,N as v,_ as ge,O as Wt,P as pt,Q as Et,R as ye,S as xe,T as Kt,U as j,V as vt,W as Ce,X as _t,Y as Se,Z as O,$ as we,a0 as ke,a1 as Te,a2 as Qt,a3 as rt,a4 as De,a5 as Ae,a6 as Me,a7 as Pe,a8 as Ie,a9 as Ht}from"./app-DglcwPX7.js";import{e as Oe,D as It,x as o,l as ft,o as Ve,c as Ge,t as Ot,A as Le,n as X,L as zt,i as Ne}from"./vidstack-rsZGrNIW-BiUwPbUx.js";class Be extends Ge{constructor(t){super(t),this.h=null,this.w=!1,this.$=null,this.w=t.type===Ot.ATTRIBUTE||t.type===Ot.BOOLEAN_ATTRIBUTE}render(t){return t!==this.h&&(this.disconnected(),this.h=t,this.isConnected&&this.Gl()),this.h?this.x(Bt(this.h)):Le}reconnected(){this.Gl()}disconnected(){var t;(t=this.$)==null||t.call(this),this.$=null}Gl(){this.h&&(this.$=A(this.l.bind(this)))}x(t){return this.w?ft(t):t}y(t){this.setValue(this.x(t))}l(){var t;this.y((t=this.h)==null?void 0:t.call(this))}}function i(e){return Oe(Be)(h(e))}class qt{constructor(t,s){this._m=t,this.La=s,this.elements=new Set,this.Gc=Nt(this.Ha.bind(this))}connect(){this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0,subtree:!0});L(()=>t.disconnect()),L(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){he(t)?(s.textContent="",s.append(t)):(It(null,s),It(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const a=s.getAttribute("data-class");a&&n.classList.add(...a.split(" "))}Ha(t){if(t&&!t.some(a=>a.addedNodes.length))return;let s=!1,n=this._m.flatMap(a=>[...a.querySelectorAll("slot")]);for(const a of n)!a.hasAttribute("name")||this.elements.has(a)||(this.elements.add(a),s=!0);s&&this.La(this.elements)}}let Re=0,q="data-slot-id";class Ut{constructor(t){this._m=t,this.Gc=Nt(this.Ha.bind(this)),this.slots=new qt(t,this.Ha.bind(this))}connect(){this.slots.connect(),this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0});L(()=>t.disconnect())}Ha(){for(const t of this._m)for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let a=s.getAttribute(q);a||s.setAttribute(q,a=++Re+"");for(const l of this.slots.elements){if(l.getAttribute("name")!==n||l.getAttribute(q)===a)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,l),l.setAttribute(q,a)}}}}function Fe({name:e,class:t,state:s,paths:n,viewBox:a="0 0 32 32"}){return o`<svg
    class="${"vds-icon"+(t?` ${t}`:"")}"
    viewBox="${a}"
    fill="none"
    aria-hidden="true"
  ...
  `}function Ct(e){const{style:t}=new Option;return t.color=e,t.color.match(/\((.*?)\)/)[1].replace(/,/g," ")}let ze=0;function D({label:e="",value:t="",children:s}){if(!e)return o`
      <div class="vds-menu-section">
        <div class="vds-menu-section-body">${s}</div>
      </div>
    `;const n=`vds-menu-section-${++ze}`;return o`
  ...
  `}function qe({value:e=null,options:t,hideLabel:s=!1,children:n=null,onChange:a=null}){function l(r){const{value:p,label:c}=r;return o`
  ...
  `}function P({group:e,label:t,option:s,defaultValue:n,cssVarName:a,getCssVarValue:l}){const{player:r}=k(),{translations:p}=u(),c=pt(kt),$=`${e}-${t.toLowerCase()}`,f=x(n),m=()=>S(p,t),b=localStorage.getItem(`vds-player:${$}`);b&&g(b);function g(C){var w;f.set(C),localStorage.setItem(`vds-player:${$}`,C),(w=r.el)==null||w.style.setProperty(`--media-user-${a}`,(l==null?void 0:l(C,r))??C)}c.all.add(y),L(()=>void c.all.delete(y));function y(){g(n),I()}function I(){r.dispatchEvent(new Event("vds-font-change"))}if(s.type==="color"){let C=function(w){g(w.target.value),I()};return Q({label:i(m),children:o`
        <input
          ...
          @input=${C}
        />
      `})}if(s.type==="slider"){let C=function(z){g(z.detail+"%"),I()};const{min:w,max:V,step:F,upIcon:H,downIcon:W}=s;return st({label:i(m),value:i(f),upIcon:H,downIcon:W,isMin:()=>f()===w+"%",isMax:()=>f()===V+"%",children:o`
        <media-slider
          class="vds-slider"
          min=${w}
          max=${V}
    ...
    <media-menu class=${`vds-${$}-menu vds-menu`}>
      ${B({label:m,hint:ot})}
      <media-menu-items class="vds-menu-items">
        ${qe({value:f,options:R,onChange({detail:C}){g(C),I()}})}
      </media-menu-items>
    </media-menu>
